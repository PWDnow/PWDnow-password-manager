...
import { Shield, ArrowRight, CheckCircle2, Loader2, ShieldAlert } from 'lucide-react';
...
import { loadMfaConfig } from '../utils/mfa';
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="mb-10">
            ...
            <p className="text-on-surface-variant text-base">
              {t('login.subtitle', 'Enter your credentials to access your secure vault.')}
            </p>
          </div>
           ...
           window.location.hostname !== '127.0.0.1' && (
            <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/30 rounded-xl flex items-start gap-3" role="alert">
              ...
              <p className="text-amber-700 dark:text-amber-300 text-sm leading-snug">
                <strong>Insecure connection (HTTP)</strong> — credentials are transmitted without encryption. Configure Nginx with TLS before using in production.
              </p>
            </div>
          )}
