...
export default function NotFound() {
  ...
  return (
    <main className="min-h-screen bg-surface flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-8xl font-headline font-black tracking-tighter text-black dark:text-white mb-4 leading-none">404</h1>
      <h2 className="text-2xl font-bold text-black dark:text-white mb-6 tracking-tight">{t('notfound.title', 'Vault Not Found')}</h2>
