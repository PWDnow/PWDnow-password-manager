        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-outline-variant/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="share-modal-title" className="font-bold text-lg text-black dark:text-white">{t('share.shareCredential', 'Share Credential')}</h2>
                <p className="text-xs text-on-surface-variant truncate max-w-[200px]">{credential.service}</p>
              </div>
            </div>
            <button onClick={onClose} aria-label={t('common.close', 'Close')} className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-surface-container-high transition-colors text-on-surface-variant">
