...
const { pbkdf2Async, scryptHash, constEq, hashPassword, verifyPassword, MFA_MAX_ATTEMPTS, isMfaLocked, recordMfaFailure, clearMfaFailure, PARTIAL_MFA_TTL_MS, mfaPendingPath, saveMfaPending, issueMfaToken, consumeMfaToken, storeEmailOtp, consumeEmailOtp, _usedTotpPeriods, verifyTotpCode, _setupOtps, _parseBrowserFromUA, _parseOSFromUA, _escHtml, sendOtpEmail, readUserBlob, writeUserBlob, readUserBlobAsync, writeUserBlobAsync, secureOverwriteDir, performServerWipe } = utils;
