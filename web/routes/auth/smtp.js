...
const { pbkdf2Async, scryptHash, constEq, MFA_MAX_ATTEMPTS, PARTIAL_MFA_TTL_MS, mfaPendingPath, saveMfaPending, _usedTotpPeriods, _setupOtps, _parseBrowserFromUA, _parseOSFromUA, _escHtml, readUserBlobAsync, writeUserBlobAsync, secureOverwriteDir } = utils;
