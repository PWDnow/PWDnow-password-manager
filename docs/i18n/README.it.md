...
Requisiti: Node.js 20 o superiore, Rust 1.94 o superiore (fissato in `daemon/rust-toolchain.toml`), `protoc`, e gli header di sviluppo per `libsodium`, `sqlcipher` e `libfido2`.
