...
Requisitos: Node.js 24 o superior, Rust 1.94 o superior (fijado en `daemon/rust-toolchain.toml`), `protoc`, y las cabeceras de desarrollo de `libsodium`, `sqlcipher` y `libfido2`.
